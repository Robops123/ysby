<template>
	<view class="productDetail">
				...
				<view class="comment-item" v-for="(item, index) in product.commonts" :key="index">
					<view class="comment-item-left">
						<view class="head-content-wrapper">
							<view class="head-icon-content"><image class="head-icon" lazy-load="true" :src="item.icon"></image></view>
							<view class="head-name">{{ item.nickname }}</view>
						</view>
						<view class="comment-content">{{ item.comment }}</view>
					</view>
					<view class="comment-item-right"><image class="product-img" lazy-load="true" :src="item.productImg"></image></view>
				</view>
			</scroll-view>
		</view>
		<!--商品详情  -->
		<view class="detail-wrapper">
			...
			<view class="content"><image class="product-detail-img" mode="widthFix" lazy-load="true" :src="product.details"></image></view>
		</view>
		<!-- 底部footer -->
